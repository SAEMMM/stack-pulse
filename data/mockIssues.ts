...
export const mockIssues: Issue[] = [
  {
    ...
    summary: {
      en: "Next.js 16.2 is now available.",
      ko: "Next.js 16.2가 출시되었습니다.",
    },
    interpretation: {
      en: [
    ...
    impact: {
      level: "medium",
      audience: ["Next.js users", "App Router teams"],
      reason: {
    ...
    sourceCount: 4,
    sources: [
      { title: "Next.js release notes", url: "https://nextjs.org" },
      { title: "Vercel blog", url: "https://vercel.com/blog" },
    ],
  ...
  },
  {
    ...
    interpretation: {
      en: [
        ...
        "The key decision is dependency exposure, not language usage alone.",
      ],
      ko: [
        "영향 여부는 TypeScript 사용 자체보다, 해당 패키지가 빌드 파이프라인에 포함됐는지가 핵심입니다.",
        "특히 CI 환경과 사내 템플릿을 공유하는 조직에서 영향 가능성이 큽니다.",
        "언어 이슈라기보다 의존성 노출 범위를 먼저 확인해야 하는 사건입니다.",
      ],
    },
    action: {
      en: [
    ...
    impact: {
      level: "high",
      audience: ["Frontend teams", "Platform owners", "Tech leads"],
      reason: {
    ...
    sourceCount: 3,
    sources: [
      { title: "Security advisory", url: "https://github.com/advisories" },
      { title: "Maintainer post", url: "https://github.com" },
    ],
  ...
  },
  {
    ...
    interpretation: {
      en: [
        ...
        "The real impact is on internal code guidelines, not immediate user-facing behavior.",
      ],
      ko: [
        "오늘 배포가 깨지는 이슈는 아니지만, 앞으로의 React 코딩 규칙에는 영향을 줍니다.",
        "컴파일러 도입을 검토 중인 팀은 custom hook, memoization 패턴을 다시 봐야 합니다.",
        "즉시 장애보다 내부 개발 가이드 수정 필요성이 더 큰 이슈입니다.",
      ],
    },
    action: {
      en: [
    ...
    impact: {
      level: "medium",
      audience: ["React teams", "Tech leads"],
      reason: {
    ...
    sourceCount: 2,
    sources: [
      { title: "React RFC", url: "https://github.com/reactjs" },
      { title: "React docs discussion", url: "https://react.dev" },
    ],
